...
$sql111 = "select sum(Infectati) from Cazurile where Data = '2021-12-01' and IdJudet = 19";
$sql222 = "select sum(Vindecati) from Cazurile where Data = '2021-12-01' and IdJudet = 19";
$sql333 = "select sum(Vaccinati) from Cazurile where Data = '2021-12-01' and IdJudet = 19";
$sql444 = "select sum(Decedati) from Cazurile where Data = '2021-12-01' and IdJudet = 19";
...
$sql1= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-13' and IdJud = 19";
$sql2= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-14' and IdJud = 19";
$sql3= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-15' and IdJud = 19";
$sql4= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-16' and IdJud = 19";
$sql5= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-17' and IdJud = 19";
$sql6= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-19' and IdJud = 19";
$sql7= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-19' and IdJud = 19";
...
$sql11= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-13' and IdJud = 19";
$sql12= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-14' and IdJud = 19";
$sql13= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-15' and IdJud = 19";
$sql14= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-16' and IdJud = 19";
$sql15= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-17' and IdJud = 19";
$sql16= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-19' and IdJud = 19";
$sql17= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-19' and IdJud = 19";
...
$sql21= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-13' and IdJud = 19";
$sql22= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-14' and IdJud = 19";
$sql23= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-15' and IdJud = 19";
$sql24= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-16' and IdJud = 19";
$sql25= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-17' and IdJud = 19";
$sql26= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-19' and IdJud = 19";
$sql27= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-19' and IdJud = 19";
...
$sql31= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-13' and IdJud = 19";
$sql32= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-14' and IdJud = 19";
$sql33= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-15' and IdJud = 19";
$sql34= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-16' and IdJud = 19";
$sql35= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-17' and IdJud = 19";
$sql36= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-19' and IdJud = 19";
$sql37= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-19' and IdJud = 19";
...
<head>
    ...
    <div class = "box">
<h1><p style="text-align:center">Judetul Giurgiu</p></h1>
</div>
</head>
<style>
    body {
