...
$sql111 = "select sum(Infectati) from Cazurile where Data = '2021-12-01' and IdJudet = 21";
$sql222 = "select sum(Vindecati) from Cazurile where Data = '2021-12-01' and IdJudet = 21";
$sql333 = "select sum(Vaccinati) from Cazurile where Data = '2021-12-01' and IdJudet = 21";
$sql444 = "select sum(Decedati) from Cazurile where Data = '2021-12-01' and IdJudet = 21";
...
$sql1= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-13' and IdJud = 21";
$sql2= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-14' and IdJud = 21";
$sql3= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-15' and IdJud = 21";
$sql4= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-16' and IdJud = 21";
$sql5= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-17' and IdJud = 21";
$sql6= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-18' and IdJud = 21";
$sql7= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-19' and IdJud = 21";
...
$sql11= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-13' and IdJud = 21";
$sql12= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-14' and IdJud = 21";
$sql13= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-15' and IdJud = 21";
$sql14= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-16' and IdJud = 21";
$sql15= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-17' and IdJud = 21";
$sql16= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-18' and IdJud = 21";
$sql17= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-19' and IdJud = 21";
...
$sql21= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-13' and IdJud = 21";
$sql22= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-14' and IdJud = 21";
$sql23= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-15' and IdJud = 21";
$sql24= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-16' and IdJud = 21";
$sql25= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-17' and IdJud = 21";
$sql26= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-18' and IdJud = 21";
$sql27= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-19' and IdJud = 21";
...
$sql31= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-13' and IdJud = 21";
$sql32= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-14' and IdJud = 21";
$sql33= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-15' and IdJud = 21";
$sql34= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-16' and IdJud = 21";
$sql35= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-17' and IdJud = 21";
$sql36= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-18' and IdJud = 21";
$sql37= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-19' and IdJud = 21";
...
<head>
    <title>Judetul Harghita </title>
    
    <div class = "box">
<h1><p style="text-align:center">Judetul Harghita</p></h1>
</div>
</head>
<style>
    body {
