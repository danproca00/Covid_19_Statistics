...
$sql1= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-13' and IdJud= 14";
$sql2= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-14' and IdJud= 14";
$sql3= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-15' and IdJud= 14";
$sql4= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-16' and IdJud= 14";
$sql5= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-17' and IdJud= 14";
$sql6= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-18' and IdJud= 14";
$sql7= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-19' and IdJud= 14";
...
$sql11= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-13' and IdJud= 14";
$sql12= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-14' and IdJud= 14";
$sql13= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-15' and IdJud= 14";
$sql14= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-16' and IdJud= 14";
$sql15= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-17' and IdJud= 14";
$sql16= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-18' and IdJud= 14";
$sql17= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-19' and IdJud= 14";
...
$sql21= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-13' and IdJud= 14";
$sql22= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-14' and IdJud= 14";
$sql23= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-15' and IdJud= 14";
$sql24= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-16' and IdJud= 14";
$sql25= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-17' and IdJud= 14";
$sql26= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-18' and IdJud= 14";
$sql27= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-19' and IdJud= 14";
...
$sql31= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-13' and IdJud= 14";
$sql32= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-14' and IdJud= 14";
$sql33= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-15' and IdJud= 14";
$sql34= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-16' and IdJud= 14";
$sql35= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-17' and IdJud= 14";
$sql36= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-18' and IdJud= 14";
$sql37= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-19' and IdJud= 14";
...
<head>
    <title>Judetul Covasna </title>
    
    <div class = "box">
<h1><p style="text-align:center">Judetul Covasna</p></h1>
</div>
</head>
<style>
    body {
