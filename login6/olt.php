...
$sql111 = "select sum(Infectati) from Cazurile where Data = '2021-12-01' and IdJudet = 30";
$sql222 = "select sum(Vindecati) from Cazurile where Data = '2021-12-01' and IdJudet = 30";
$sql333 = "select sum(Vaccinati) from Cazurile where Data = '2021-12-01' and IdJudet = 30";
$sql444 = "select sum(Decedati) from Cazurile where Data = '2021-12-01' and IdJudet = 30";
...
$sql1= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-13' and IdJud = 30";
$sql2= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-14' and IdJud = 30";
$sql3= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-15' and IdJud = 30";
$sql4= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-16' and IdJud = 30";
$sql5= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-17' and IdJud = 30";
$sql6= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-18' and IdJud = 30";
$sql7= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-19' and IdJud = 30";
...
$sql11= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-13' and IdJud = 30";
$sql12= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-14' and IdJud = 30";
$sql13= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-15' and IdJud = 30";
$sql14= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-16' and IdJud = 30";
$sql15= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-17' and IdJud = 30";
$sql16= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-18' and IdJud = 30";
$sql17= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-19' and IdJud = 30";
...
$sql21= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-13' and IdJud = 30";
$sql22= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-14' and IdJud = 30";
$sql23= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-15' and IdJud = 30";
$sql24= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-16' and IdJud = 30";
$sql25= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-17' and IdJud = 30";
$sql26= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-18' and IdJud = 30";
$sql27= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-19' and IdJud = 30";
...
$sql31= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-13' and IdJud = 30";
$sql32= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-14' and IdJud = 30";
$sql33= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-15' and IdJud = 30";
$sql34= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-16' and IdJud = 30";
$sql35= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-17' and IdJud = 30";
$sql36= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-18' and IdJud = 30";
$sql37= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-19' and IdJud = 30";
...
<head>
    <title>Judetul Olt </title>
    
    <div class = "box">
<h1><p style="text-align:center">Judetul Olt</p></h1>
</div>
</head>
<style>
    body {
