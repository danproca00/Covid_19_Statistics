...
$sql1= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-13' and IdJud = 33";
$sql2= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-14' and IdJud = 33";
$sql3= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-15' and IdJud = 33";
$sql4= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-16' and IdJud = 33";
$sql5= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-17' and IdJud = 33";
$sql6= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-18' and IdJud = 33";
$sql7= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-19' and IdJud = 33";
...
$sql11= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-13' and IdJud = 33";
$sql12= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-14' and IdJud = 33";
$sql13= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-15' and IdJud = 33";
$sql14= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-16' and IdJud = 33";
$sql15= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-17' and IdJud = 33";
$sql16= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-18' and IdJud = 33";
$sql17= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-19' and IdJud = 33";
...
$sql21= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-13' and IdJud = 33";
$sql22= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-14' and IdJud = 33";
$sql23= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-15' and IdJud = 33";
$sql24= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-16' and IdJud = 33";
$sql25= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-17' and IdJud = 33";
$sql26= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-18' and IdJud = 33";
$sql27= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-19' and IdJud = 33";
...
$sql31= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-13' and IdJud = 33";
$sql32= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-14' and IdJud = 33";
$sql33= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-15' and IdJud = 33";
$sql34= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-16' and IdJud = 33";
$sql35= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-17' and IdJud = 33";
$sql36= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-18' and IdJud = 33";
$sql37= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-19' and IdJud = 33";
...
<head>
    <title>Judetul Salaj </title>
    
    <div class = "box">
<h1><p style="text-align:center">Judetul Salaj</p></h1>
</div>
</head>
<style>
    body {
