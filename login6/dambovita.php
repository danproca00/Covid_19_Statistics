...
$sql111 = "select sum(Infectati) from Cazurile where Data = '2021-12-01' and IdJudet = 16";
$sql222 = "select sum(Vindecati) from Cazurile where Data = '2021-12-01' and IdJudet = 16";
$sql333 = "select sum(Vaccinati) from Cazurile where Data = '2021-12-01' and IdJudet = 16";
$sql444 = "select sum(Decedati) from Cazurile where Data = '2021-12-01' and IdJudet = 16";
...
$sql1= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-13' and IdJud = 16";
$sql2= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-14' and IdJud = 16";
$sql3= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-15' and IdJud = 16";
$sql4= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-16' and IdJud = 16";
$sql5= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-17' and IdJud = 16";
$sql6= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-18' and IdJud = 16";
$sql7= "select sum(NrInfectati) from SituatieJud where Dati='2021-12-19' and IdJud = 16";
...
$sql11= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-13' and IdJud = 16";
$sql12= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-14' and IdJud = 16";
$sql13= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-15' and IdJud = 16";
$sql14= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-16' and IdJud = 16";
$sql15= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-17' and IdJud = 16";
$sql16= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-18' and IdJud = 16";
$sql17= "select sum(NrVindecati) from SituatieJud where Dati='2021-12-19' and IdJud = 16";
...
$sql21= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-13' and IdJud = 16";
$sql22= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-14' and IdJud = 16";
$sql23= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-15' and IdJud = 16";
$sql24= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-16' and IdJud = 16";
$sql25= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-17' and IdJud = 16";
$sql26= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-18' and IdJud = 16";
$sql27= "select sum(NrVaccinati) from SituatieJud where Dati='2021-12-19' and IdJud = 16";
...
$sql31= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-13' and IdJud = 16";
$sql32= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-14' and IdJud = 16";
$sql33= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-15' and IdJud = 16";
$sql34= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-16' and IdJud = 16";
$sql35= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-17' and IdJud = 16";
$sql36= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-18' and IdJud = 16";
$sql37= "select sum(NrDecedati) from SituatieJud where Dati='2021-12-19' and IdJud = 16";
...
<head>
    <title>Judetul Dambovita </title>
    
    <div class = "box">
<h1><p style="text-align:center">Judetul Dambovita</p></h1>
</div>
</head>
<style>
    body {
